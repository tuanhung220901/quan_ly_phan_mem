        ...
        <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4 ">
            <div className="flex justify-center items-center lg:flex-row flex-col gap-8">
                ...
                <div className="  w-full sm:w-96 md:w-8/12 lg:w-6/12 items-center">
                    <p className=" focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 font-normal text-base leading-4 text-gray-600">Home / Deatil / Toyota Vios</p>
                    <h2 className="font-semibold lg:text-4xl text-3xl lg:leading-9 leading-7 text-gray-800 mt-4">Toyota Vios</h2>
                    ...
                    <p className=" font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 mt-6 ">$ 7901.89</p>
                ...
                <div className=" w-full sm:w-96 md:w-8/12  lg:w-6/12 flex lg:flex-row flex-col lg:gap-8 sm:gap-6 gap-4">
                    <div className=" w-full lg:w-8/12 bg-gray-100 flex justify-center items-center">
                        <img src="https://ssa-api.toyotavn.com.vn//VehicleImgs/vios/91F2C2E421F40A687ED2EBDB1747BE82.png" alt="Wooden Chair Previw" />
                    </div>
                    <div className=" w-full lg:w-4/12 grid lg:grid-cols-1 sm:grid-cols-4 grid-cols-2 gap-6">
                        <div className="bg-gray-100 flex justify-center items-center py-4">
                            <img src="https://ssa-api.toyotavn.com.vn/Resources/Images/B7485149B2CE14387683B76FFF9B331A.png" alt="Wooden chair - preview 1" />
                        </div>
                        <div className="bg-gray-100 flex justify-center items-center py-4">
                            <img src="https://ssa-api.toyotavn.com.vn/Resources/Images/38F3451420890DF9FCCAC94F5F17D9A3.jpeg" alt="Wooden chair - preview 2" />
                        </div>
                        <div className="bg-gray-100 flex justify-center items-center py-4">
                            <img src="https://ssa-api.toyotavn.com.vn/Resources/Images/FEDFE8D6A9584D881067A8E70163ACEF.jpeg" alt="Wooden chair- preview 3" />
                        </div>
                    </div>
                </div>
            </div>
